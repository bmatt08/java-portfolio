...
public class SellerDTO {
	...
	private List<FestivalOfferDTO> festivalOffers;
	...
	public List<FestivalOfferDTO> getFestivalOfferDTOs() {
		return festivalOffers;
	}
	
	
	public void setFestivalOfferDTOs(List<FestivalOfferDTO> festivalOffers) {
